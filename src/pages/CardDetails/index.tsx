...
export const CardDetails = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 md:p-8 grid grid-cols-1 md:grid-cols-[280px_450px] justify-center items-center gap-5">
      ...
      <div className="max-w-[810px]  mx-auto px-4 pb-8 sm:px-6 md:px-8">
        <RulingInfo
          card={card.name}
          rulings={rulings}
        />
